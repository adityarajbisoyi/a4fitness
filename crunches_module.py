...
def run_crunches():
    ...
    while cap.isOpened():
        ...
        feedback_color = (0, 255, 0) if feedback in ["Crunch Up", "Down"] else (0, 200, 255)
    ...
    database.save_session("Crunches", int(count), calories_module.calculate_calories("Crunches", int(count)))
